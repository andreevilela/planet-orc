<%-- 
    Document   : erro
    Created on : 12/10/2018, 01:36:55
    Author     : Andre
--%>
...
<html>
    ...
    <body class="fundo">
        ...
        <div class="caixa100">
            ...
            <h2 class="left">Não conseguimos te identificar!</h2>
            <div class="info">
                <p><a href="login.jsp" class="link">Tentar logar novamente</a>
                <a href="cadastrar.jsp" class="link">Cadastre-se</a></p>
            </div>
            <div class="center">
