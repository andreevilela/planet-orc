<%-- 
    Document   : cadastrado
    Created on : 12/10/2018, 01:37:44
    Author     : Andre
--%>
...
<html>
    ...
    <body class="fundo2">
        ...
        <ul>
            ...
            <li><a class="active" href="cadastrar.jsp">Cadastrar</a></li>
            <li><a href="login.jsp">Entrar</a></li>
            <li><a href="index.jsp">Início</a></li>
        </ul>
        <div class="caixa100">
            <h1 class="center">Planet Orc</h1>
            <h2 class="left">Cadastrado com sucesso!</h2>
            <div class="info">
                <p><a href="login.jsp" class="link">Começe a jogar</a></p>
            </div>
            <div class="center">
